...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BS] = LAYOUT(
        ...
        KC_BSPC, CPY_PST, XXXXXXX, KC_LALT, KC_LCTL, OS_LSFT,     FN_SPC , FN_RCTL, FN_RALT, XXXXXXX, INS_SHT, KC_ENT ,
        KC_BSPC, CPY_PST, XXXXXXX, KC_LALT, KC_LCTL, OS_LSFT,     FN_SPC , FN_RCTL, FN_RALT, XXXXXXX, INS_SHT, KC_ENT 
    ),
    [_QW] = LAYOUT(
        KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,     KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS,
        KC_ESC , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   ,     KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_QUES,
    ...
    [_MK] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        _______, _______, _______, _______, _______, _______,     KC_BTN1, KC_BTN3, KC_BTN2, _______, KC_BTN5, KC_BTN4,
        _______, _______, _______, _______, _______, _______,     KC_BTN1, KC_BTN3, KC_BTN2, _______, KC_BTN5, KC_BTN4
    ),
    [_NP] = LAYOUT(
        _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______,
        ...
        _______, _______, _______, KC_DOT , KC_0   , KC_PENT,     _______, KC_0   , KC_DOT , _______, _______, _______,
        _______, _______, _______, KC_DOT , KC_0   , KC_PENT,     _______, KC_0   , KC_DOT , _______, _______, _______
    ),
    [_FN] = LAYOUT(
        ...
        _______, _______, _______, KC_DOT , KC_0   , KC_PENT,     _______, KC_RCTL, KC_RALT, _______, _______, TG(_FN),
        _______, _______, _______, KC_DOT , KC_0   , KC_PENT,     _______, KC_RCTL, KC_RALT, _______, _______, TG(_FN)
    ),
    [MY_COMMAND] = LAYOUT(
        _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______,
