    ...
    [0] = LAYOUT_60keys(
     ...
     _G(KC_ESC), KC_A   , KC_S   , KC_D   , KC_F   , KC_G   ,                   KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,
        KC_LALT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                   KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RALT,
                 XXXXXXX, XXXXXXX, XXXXXXX, KC_LCTL, KC_LSFT, BSPC_A , KC_ENT , SPC_FN , KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [1] = LAYOUT_60keys(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(1)  ,                   KC_PERC, KC_1   , KC_2   , KC_3   , KC_EQL , XXXXXXX,
                 XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN1, KC_BTN3, KC_BTN2, KC_PENT, KC_0   , KC_DOT , XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [2] = LAYOUT_60keys(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   TG(2)  , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                 XXXXXXX, XXXXXXX, XXXXXXX, KC_LCTL, KC_LSFT, KC_LALT, KC_BTN1, KC_BTN3, KC_BTN2, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [3] = LAYOUT_60keys(
        ...
        _______, KC_LPRN, KC_1   , KC_2   , KC_3   , TG(1)  ,                   TG(2)  , KC_PGUP, KC_LABK, KC_RABK, KC_RPRN, _______,
                 XXXXXXX, XXXXXXX, XXXXXXX, KC_DOT , KC_0   , KC_BSPC, XXXXXXX, KC_PSCR, KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [4] = LAYOUT_60keys(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
